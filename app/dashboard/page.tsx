    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-[#c689de] shadow-md rounded-lg p-6 text-center">
          ...
          <div className="bg-[#df73c1] shadow-md rounded-lg p-6 text-center">
          ...
          <div className="bg-[#c46ec1] shadow-md rounded-lg p-6 text-center">
          ...
          <div className="bg-[#ca74a0] shadow-md rounded-lg p-6 text-center">
